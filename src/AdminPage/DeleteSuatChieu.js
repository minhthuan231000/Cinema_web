...
const headCells = [
    { id: 'IdPhim', numeric: true, disablePadding: true, label: 'ID Phim' },
    { id: 'IdRap', numeric: true, disablePadding: true, label: 'ID Rạp' },
...
<<<<<<< HEAD
        let request = new Request(`${process.env.REACT_APP_DOMAIN}/delete/showtime`, {
=======
        let request = new Request(`${DOMAIN}/delete/showtime`, {
>>>>>>> main
            method: 'POST',
